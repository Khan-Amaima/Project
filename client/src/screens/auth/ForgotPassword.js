    ...
    <Container maxWidth='auto' style={{ height: '100vh', backgroundColor: AppColors.backgroundColor, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <Container component="main" maxWidth='sm' disableGutters >
        ...
        >
          ...
          <Typography component="h1" variant="h5" style={{ fontFamily: 'Poppins', fontWeight: 500, color: AppColors.tertiary, marginTop: 40, }} sx={{ typography: FontSizeStandards.mainHeading }}>
            Forgot password ?
          </Typography>
          ...
          <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 3, margin: '40px' }} style={{ width: '85%' }}>
            ...
            <CustomButton type={'submit'} text={"Get new password"} buttonStyle={{
              borderRadius: '4px',
              padding: '10px',
