  ...
  return (
    <Container maxWidth='100vw' style={{ height: '82vh', display: 'flex', justifyContent: 'center', alignItems: 'center'  }}>
       <Container style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center',  }}>
          ...
          />
          <Typography component="h1" variant="h5" style={{ fontFamily: 'Poppins', fontWeight: 600, color: AppColors.secondary,lineHeight: "20px" , marginTop:50,marginBottom:30 }}sx={{ typography: { xs: MainHeading.xs, sm:  MainHeading.sm, md:MainHeading.md,lg: MainHeading.lg}}}>
          No Content Uploaded
          </Typography>
